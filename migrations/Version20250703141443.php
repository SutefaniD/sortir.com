 ...
 */
final class Version20250703141443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, zip_code VARCHAR(6) DEFAULT NULL, UNIQUE INDEX UNIQ_2D5B02345E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE outing (id INT AUTO_INCREMENT NOT NULL, organizer_id INT DEFAULT NULL, status_id INT DEFAULT NULL, location_id INT NOT NULL, site_id INT NOT NULL, name VARCHAR(255) NOT NULL, starting_date_time DATETIME NOT NULL, duration INT NOT NULL, registration_deadline DATETIME NOT NULL, max_participants INT NOT NULL, outing_details LONGTEXT NOT NULL, cancel_reason LONGTEXT DEFAULT NULL, INDEX IDX_F2A10625876C4DDA (organizer_id), INDEX IDX_F2A106256BF700BD (status_id), INDEX IDX_F2A1062564D218E (location_id), INDEX IDX_F2A10625F6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, site_id INT NOT NULL, last_name VARCHAR(150) NOT NULL, first_name VARCHAR(150) NOT NULL, username VARCHAR(150) NOT NULL, phone VARCHAR(14) NOT NULL, email VARCHAR(150) NOT NULL, password VARCHAR(255) NOT NULL, administrator TINYINT(1) NOT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_D79F6B11F85E0677 (username), INDEX IDX_D79F6B11F6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
